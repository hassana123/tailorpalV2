    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-brand-border/50 bg-brand-cream/40 flex-shrink-0">
      ...
      <div className="flex items-center gap-1 self-end sm:self-auto">
        ...
        <button
          ...
          className="w-8 h-8 rounded-xl flex items-center justify-center text-brand-stone hover:bg-brand-cream transition-colors"
        >
        ...
        <button
          ...
          className="w-8 h-8 rounded-xl flex items-center justify-center text-brand-stone hover:bg-red-50 hover:text-red-500 transition-colors"
        >
          <Trash2 size={15} />
        </button>
      </div>
