      ...
      <div className="min-h-screen bg-brand-cream">
        ...
        <div className="max-w-xl mx-auto px-5 py-24 text-center">
          ...
          <Link href="/marketplace">
            <button className="h-10 px-6 rounded-xl bg-brand-ink text-white text-sm font-semibold hover:bg-brand-charcoal transition-all flex items-center gap-2 mx-auto">
              <ArrowLeft size={14} />
              Back to marketplace
            </button>
          </Link>
